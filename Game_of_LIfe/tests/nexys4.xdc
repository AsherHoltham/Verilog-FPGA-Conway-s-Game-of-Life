...
#aaaaaaaaaaaa   set_property PACKAGE_PIN L13 [get_ports QuadSpiFlashCS]					
#aaaaaaaaaaaa   	set_property IOSTANDARD LVCMOS33 [get_ports QuadSpiFlashCS]
...
#aaaaaaaaaaaa   set_property PACKAGE_PIN L18 [get_ports RamCS]					
#aaaaaaaaaaaa   	set_property IOSTANDARD LVCMOS33 [get_ports RamCS]
...
#aaaaaaaaaaaa   set_property PACKAGE_PIN H14 [get_ports MemOE]					
#aaaaaaaaaaaa   	set_property IOSTANDARD LVCMOS33 [get_ports MemOE]
#Bank = 14, Pin name = IO_0_14,								Sch name = CRAM_WEN
#aaaaaaaaaaaa   set_property PACKAGE_PIN R11 [get_ports MemWR]					
#aaaaaaaaaaaa   	set_property IOSTANDARD LVCMOS33 [get_ports MemWR]
